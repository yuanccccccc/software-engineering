<template>
  <Row class="page2">
    <Col :span="7">
      <div class="left">
        <span class="title"
          ><span class="title-text">各省份水质分析</span></span
        >
    ...
    <Col :span="10" style="padding: 0 1%">
      ...
      <div class="center-bottom">
        <span class="title"
          ><span class="title-text">流域内水质等级分布</span></span
        >
        <span class="angle1"></span>
        <span class="angle2"></span>
        <span class="angle3"></span>
    ...
    <Col :span="7">
      <div class="right-1">
        <div class="right1-1">
          <span class="title"
            ><span class="title-text">历史数据分析</span></span
          >
          <span class="angle1"></span>
          <span class="angle2"></span>
          <span class="angle3"></span>
...
const MyWaterChart = () => import("./components/page2/temp");
const phtChart = () => import("./components/page2/pht");
const EightRadarCharts = () => import("./components/page2/eight_radar");
const WaterQualityChart = () => import("./components/page2/line");
const tableaa = () => import("./components/page2/table");
export default {
  name: "page2",
  components: {
    chinaMap,
